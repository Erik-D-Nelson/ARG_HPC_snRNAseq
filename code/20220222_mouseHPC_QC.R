...
pdf("plots/02222022_mouseHPC_totalQCmetrics.pdf")
grid.arrange(
  plotColData(sce.total, x="sample_name",y="sum", colour_by="discard") +
    scale_y_log10() + ggtitle("Total count"),
  plotColData(sce.total, x="sample_name",y="detected", colour_by="discard") +
    scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce.total, x="sample_name",y="subsets_Mito_percent",
...
pdf("plots/02222022_mouseHPC_indivQCmetrics.pdf")
grid.arrange(
  plotColData(sce.total, x="sample_name",y="sum", colour_by="qc.lib") +
    scale_y_log10() + ggtitle("Total count"),
  plotColData(sce.total, x="sample_name",y="detected", colour_by="qc.nexprs") +
    scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce.total, x="sample_name",y="subsets_Mito_percent",
              colour_by="high.mito") + ggtitle(paste0("Mito % (cutoff = ", mitoCutoffs,")")),
  ncol=1
